...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<% List<ProductVO> normal = (List)request.getAttribute("normal");%>
<!DOCTYPE html>
<html lang="ko">
	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					<a href="home" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
					<a href="home" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
				</h1>
									...
									<div class="card_body">
										...
										<div class="middle">
											<div class="card_detail">
												...
												<h4 class="tit"><%=vo.getDescription() %></h4>
												<ul class="detail">
													<li class="item">
												...
												<div class="price_summary">
													...
													<em class="price_amount">
														<span><%=vo.getPrice()/1000 %>,000</span>
														<span class="unit">원</span>
													</em>
												</div>
												<!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
												<div class="booking_cancel C">
											...
											<div class="middle">
												<div class="card_detail">
													...
													<ul class="detail">
														<li class="item">
															<span class="item_tit">일정</span>
															<em class="item_dsc" style="white-space: nowrap; overflow: hidden">
																<%=vo.getOpening_hours() %>
															</em>
														</li>
														<li class="item">
...
$(".btn").click(function(){
	...
	var parent = $(this).parents(".card_item");
	var button = $(this)
	$.ajax({
		type : "GET",
		url : "/naver/cancel",
		...
		success:function(data){
			console.log(parent);
			$(".cancel").append(parent);
			button.remove();
			parent.children(".btn_goto_share").remove();
		}
		
	})
})
$(".btn_goto_share").click(function(){

	var parent = $(this).parents(".card_item");
	var booking = $(".btn");
	var detail = $(".card_detail")
	var updatebutton = "<div class = \"booking_cancel\">"
				    +"<a href=\"review\"><button class=\"btn\"><span>예매자 리뷰 남기기</span></button></a>"
				    +"</div>"
	$.ajax({
		type : "GET", 
		url : "/naver/cancel",
