		...
		<div class="ct">
			<div class="ct_wrap">
				...
				<div class="review_contents write">
					...
					<textarea cols="30" rows="10" class="review_textarea">
...
$('input:checkbox[name="rating2"]').change(function(){
	console.log("hi");

	$('input:checkbox[name="rating6"]').prop("checked",false);
	$('input:checkbox[name="rating3"]').prop("checked",false);
	$('input:checkbox[name="rating4"]').prop("checked",false);
	$('input:checkbox[name="rating5"]').prop("checked",false);
	if($(this).is(":checked")){
		$(this).is=true;
		$(".star_rank").empty();
...
$('input:checkbox[name="rating3"]').change(function(){
	$('input:checkbox[name="rating2"]').prop("checked",true);
	$('input:checkbox[name="rating6"]').prop("checked",false);
	$('input:checkbox[name="rating4"]').prop("checked",false);
	$('input:checkbox[name="rating5"]').prop("checked",false);
	if($(this).is(":checked")){
...
$('input:checkbox[name="rating4"]').change(function(){

	$('input:checkbox[name="rating2"]').prop("checked",true);
	$('input:checkbox[name="rating3"]').prop("checked",true);
	$('input:checkbox[name="rating6"]').prop("checked",false);
	$('input:checkbox[name="rating5"]').prop("checked",false);
	if($(this).is(":checked")){
		$(this).is=true;
...
$('input:checkbox[name="rating5"]').change(function(){

	$('input:checkbox[name="rating2"]').prop("checked",true);
	$('input:checkbox[name="rating3"]').prop("checked",true);
	$('input:checkbox[name="rating4"]').prop("checked",true);
	$('input:checkbox[name="rating6"]').prop("checked",false);
	if($(this).is(":checked")){
		$(this).is=true;
...
$('input:checkbox[name="rating6"]').change(function(){

	$('input:checkbox[name="rating2"]').prop("checked",true);
	$('input:checkbox[name="rating3"]').prop("checked",true);
	$('input:checkbox[name="rating4"]').prop("checked",true);
	$('input:checkbox[name="rating5"]').prop("checked",true);
	if($(this).is(":checked")){
		$(this).is=true;
...
$('.review_write_info').click(function(){
	$(this).hide();
	$(".review_textarea").addClass("focus");
})
	function readURL(input){
		...
		if(input.files && input.files[0]){
			...
			reader.onload = function(e){
				$(".item_thumb").attr("src",e.targetresult);
				console.log(e.targetresult);
			}
...
$("#reviewImageFileOpenInput").change(function(){
	readURL(this);
	console.log("hi");
})
